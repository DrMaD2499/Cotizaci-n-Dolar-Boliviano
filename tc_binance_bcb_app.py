...
fig_hist.update_layout(
    ...
    xaxis=dict(
        title=dict(text="Fecha", font=dict(size=12, color="#111111")),
        showgrid=True,
        gridcolor="#E5E5E5",
        tickfont=dict(color="#333333", size=11),
    ),
    yaxis=dict(
        title=dict(text="BOB / USD", font=dict(size=12, color="#111111")),
        showgrid=True,
        gridcolor="#E5E5E5",
        tickfont=dict(color="#333333", size=11),
    ),
...
with col_chart:
    ...
    fig_proj.update_layout(
        ...
        hovermode="x unified",
        title=dict(
            text=f"Proyección a 7 Días - {serie_sel}",
    ...
    st.plotly_chart(fig_proj, use_container_width=True, config={"responsive": True})
